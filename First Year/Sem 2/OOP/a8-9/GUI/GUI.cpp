...
void GUI::initGUI() {
    ...
    introduction->setText("EVENT PLANNER");
    ...
    pal2.setColor(QPalette::Button, QColor(Qt::darkCyan));
    ...
    pal3.setColor(QPalette::Button, QColor(Qt::darkCyan));
...
void GUI::saveFileType() {
    ...
    if(this->type == "CSV File") {
        this->ASB = new CSVRepository();
    }
    else if(this->type == "HTML File")
        this->ASB = new HTMLRepository();
}
